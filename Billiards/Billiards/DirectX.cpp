...
DirectX::DirectX(){
	...
	this->cam_clip_min = 0.05f;
	this->cam_clip_max = 5.f;
}
...
int DirectX::Init(Window *win_data){
	...
	light.Ambient.r  = 0.1f;   light.Ambient.g = 0.1f;   light.Ambient.b = 0.1f;
...
vec DirectX::GetCameraPos(){
	return this->cam_pos;
}

vec DirectX::GetCameraTrg(){
	return this->cam_trg;
}
